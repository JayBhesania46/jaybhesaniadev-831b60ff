        ...
        <ul className="flex flex-col items-center space-y-6 after:content-[''] after:block after:w-px after:h-24 after:bg-slate">
          <li>
            <a 
              ...
              className="text-slate hover:text-green transform hover:-translate-y-1 transition-all duration-200"
            >
              <Github size={20} />
            </a>
          </li>
      ...
      <div className="fixed bottom-0 right-10 hidden xl:block">
        <div className="flex flex-col items-center space-y-6 after:content-[''] after:block after:w-px after:h-24 after:bg-slate">
          <a 
            ...
            className="font-mono text-sm text-slate hover:text-green transform hover:-translate-y-1 transition-all duration-200 vertical-text"
